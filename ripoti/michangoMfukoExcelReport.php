...
if(isset($_POST['xlsreport'])) {
	...
	$sql="select members.user_id, members.fname, members.mname, members.lname, mfukomaendeleo.amount, mfukomaendeleo.month, mfukomaendeleo.financial_year, mfukomaendeleo.referencenumber, mfukomaendeleo.date
		FROM mfukomaendeleo
		INNER JOIN members ON mfukomaendeleo.user_id=members.user_id WHERE mfukomaendeleo.approval = '1'  ORDER BY mfukomaendeleo.date ASC";
	...
	header('Content-Disposition:attachment;filename=michangoMfukowaMaendeleo.xls');
	echo $table;
