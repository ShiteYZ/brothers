...
if(isset($_POST['xlsreport'])) {
	...
	$sql="select marejesho.rejesho_id, marejesho.mkopo_id, marejesho.jina, marejesho.mkopojumla, SUM(marejesho.rejesho) as rejesho, mkopo.kiasi_mkopo, mkopo.tarehe_kurudisha, mkopo.hali_malipo
			FROM marejesho
			INNER JOIN mkopo ON marejesho.mkopo_id=mkopo.mkopo_id WHERE mkopo.hali_malipo = 1 OR mkopo.hali_malipo = 2 GROUP by marejesho.mkopo_id ORDER BY mkopo.tarehe ASC";
