										...
										<div class="col-10">
											<div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
												<div class="card-body">
													...
													<fieldset>
																<legend>Lipisha Mchango wa Mfuko wa Maendeleo</legend>
																		<!--Search box-->
																		<div class="row">
																...
																<div class="row">
																		...
																		<div class="col-md-8 mb-8 py-5">
																				<div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
																					<div class="card-body">
																							<form class="form-detail" name="addstaffform" method="POST" action="index.php?p=lipishaMchangosubmit" enctype="multipart/form-data" onsubmit="return process();">
																									<div class="row">
