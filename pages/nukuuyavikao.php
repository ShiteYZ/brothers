																							...
																							<form class="form-detail" name="addstaffform" method="POST" action="#" enctype="multipart/form-data" onsubmit="return process();">
																									<div class="row">
																										...
																										<div class="form-outline">
																											...
																											<input type="text" name="jinaKikao" class="form-control form-control-lg" required/>
																										</div>
																										</div>
																										...
																										<div class="form-group py-4">
																											<button type="reset" name="wasilisha" class="form-control btn btn-warning rounded submit px-3">Wasilisha</button>
																										</div>
																									</div>
																							</form>
																					</div>
