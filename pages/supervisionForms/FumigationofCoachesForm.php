...
<form class="form-detail" name="searchform" method="POST" action="index.php?p=supervisionForm" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-6 py-4"><!--COL-3-->
        <fieldset>
        <legend>Fumigation of Coaches Form</legend>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12 mb-12">
                                <div class="form-outline">
                                    <fieldset><hr />
                                    <label class="form-label" for="jinaKikao"><i class="fa fa-angle-double-right"></i>  Fumigation of Coaches</label>
                                    </fieldset>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="fumigation" id="provided"
                                            value="Fumigation Done" checked />
                                            <label class="form-check-label" for="Provided">Fumigation Performed</label>
                                        </div>

                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="fumigation" id="notprovided"
                                            value="Fumigation Not Done" />
                                            <label class="form-check-label" for="Not Provided">Fumigation Performed</label>
                                        </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-12">
                                <div class="form-outline">
                                    <fieldset><hr />
                                    <label class="form-label" for="jinaKikao"><i class="fa fa-angle-double-right"></i>  Application of Certified Pesticides</label>
                                    </fieldset>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="applypesticides" id="provided"
                                            value="Applied" checked />
                                            <label class="form-check-label" for="Provided">Yes</label>
                                        </div>

                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="applypesticides" id="notprovided"
                                            value="Not Applied" />
            ...
            <div class="form-group">
                <button type="submit" name="fumigationSubmitBtn" class="form-control btn btn-warning rounded submit px-3" style="background-color: #00B074;">Submit Fumigation Report</button>
            </div>
        <fieldset>
        </div><!-- END OF COL-3-->
        </div>
