										...
										<div class="col-10">
											<nav aria-label="breadcrumb">
												<ol class="breadcrumb">
													...
													<li class="breadcrumb-item"><a href="#">Lipisha Ada ya Mwanachama</a></li>
												</ol>
											</nav>
											<div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
												<div class="card-header bg-default" style="border-radius: 15px;">
														<div class="row">
																<div class="col-md-4">
																	<i class="fa fa-angle-double-right"></i>	Lipisha Ada
																</div>
																<div class="offset-md-6 col-md-2">
																	<div class="input-group">
																		<a href="index.php?p=thibitishamalipo">
																			<button class="btn btn-primary rounded-pill" type="button">
																						<i class="fa fa-ok">Thibitisha Malipo</i>
																			</button> 
																		</a> 
																	</div>
																</div>
																									...
																									<div class="row">
																										...
																										<div class="form-outline">
																											<select class="form-control" name="Previlege">
																												...
																												<option value="Chairperson">Ada</option>	
																												<option value="Secretary">Mfuko wa Maendeleo</option>
																											</select>
