				...
				<div class="modal fade" id="wasilishaMalipo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
					<div class="modal-dialog">
						...
						<?php
							...
							{
						?>
						<form class="form-detail" name="attachaddendumform" method="POST" action="index.php?p=lipishaadasubmit" enctype="multipart/form-data" onsubmit="return process();">
							
							<div class="modal-header">
								<h5 class="modal-title" id="staticBackdropLabel">Karibu Ndugu <?php print $data["fname"]." ".$data["lname"]; ?> <br/> Kuwasilisha Malipo ya Ada</h5>
								...
								<div class="modal-body">
									...
									<div class="row">
										...
										<div class="form-outline">
											...
											<input type="tel" name="fedha" id="number-input" class="form-control form-control-lg" required/>
										...
										<div class="col-10">
											<nav aria-label="breadcrumb">
												<ol class="breadcrumb">
													...
													<li class="breadcrumb-item"><a href="#">Ada</a></li>
													<li class="breadcrumb-item active" aria-current="page">Ada za wanachama</li>
												</ol>
											</nav>
											<div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
												...
												<div class="card-body">
																		...
																		<div class="row">
																			...
																			<div class="col-md-2">
																				<div class="input-group">
																					<button class="btn btn-outline-info rounded-pill" type="button" data-bs-toggle="modal" data-bs-target="#wasilishaMalipo">
																								<i class="fa fa-cc-paypal">Lipia Ada</i>
																					</button> 
																				</div>
																			</div>
																			<?php
																				if($mtiasahihi == 'Mwekahazina'){
																			?>
																			<div class="col-md-2">
																				<div class="input-group">
																					<a href="index.php?p=lipiaada">
																			...
																			<div class="col-md-2">
																				<div class="input-group">
																					<a href="index.php?p=malipoAdaKataliwa">
...
<script>
	document.querySelector("#number-input").oninput = (function(e) {
        ...
        if (input.value == "" || input.value == undefined || isNaN(parseInt(input.name)) == true) {
            ...
            input.value = parseInt(input.name).toLocaleString('en-US', {maximumSignificantDigits : 21})
        }        
    })
</script>
<?php
